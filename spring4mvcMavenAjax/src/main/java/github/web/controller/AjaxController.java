package github.web.controller;


import com.fasterxml.jackson.annotation.JsonView;
import github.web.jsonview.Views;
import github.web.model.AjaxResponseBody;
import github.web.model.SearchCriteria;
import github.web.model.User;
...
public class AjaxController {
    ...
    private void iniDataForTesting() {
        ...
        User user1 = new User("Tymur", "pass123", "Tymur@gmail.com", "012-1234567", "address 123");
        User user2 = new User("yflow", "pass456", "yflow@yahoo.com", "016-7654321", "address 456");
        User user3 = new User("laplap", "pass789", "tymur@gmail.com", "012-111111", "address 789");
        users.add(user1);
        users.add(user2);
        users.add(user3);
